...
- [ ] Multi-language clients (Rust first; Go / Python FFI or REST gateway) — **deferred** (Python/Go/Java through v0.140; Rust LeaveGroup 14 **v0.137**)
...
Still deferred: multi-language clients (Python/Go/Java through v0.140; Rust LeaveGroup 14 **v0.137**), full chaos-mesh suites / long fuzz
