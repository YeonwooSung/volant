...
- [ ] Multi-language clients (Rust first; Go / Python FFI or REST gateway) — **deferred** (Python/Go/Java through v0.135; Rust Heartbeat 14 **v0.135**)
...
Still deferred: multi-language clients (Python/Go/Java through v0.135; Rust Heartbeat 14 **v0.135**), full chaos-mesh suites / long fuzz
