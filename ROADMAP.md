...
- [ ] Multi-language clients (Rust first; Go / Python FFI or REST gateway) — **deferred** (Python/Go/Java through v0.180; Rust alter_config **v0.178**)
...
Still deferred: multi-language clients (Python/Go/Java through v0.180; Rust alter_config **v0.178**), full chaos-mesh suites / long fuzz
