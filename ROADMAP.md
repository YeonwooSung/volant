...
- [ ] Multi-language clients (Rust first; Go / Python FFI or REST gateway) — **deferred** (Python/Go/Java through v0.130; Rust **v0.125**)
...
Still deferred: multi-language clients (Python/Go/Java through v0.130; Rust **v0.125**), full chaos-mesh suites / long fuzz
