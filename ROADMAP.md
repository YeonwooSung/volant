...
- [ ] Multi-language clients (Rust first; Go / Python FFI or REST gateway) — **deferred** (Python/Go/Java through v0.95; Rust **v0.91–v0.94**)
...
Still deferred: multi-language clients (Python/Go/Java through v0.95; Rust **v0.91–v0.94**), full chaos-mesh suites / long fuzz
