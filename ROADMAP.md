...
- [ ] Multi-language clients (Rust first; Go / Python FFI or REST gateway) — **deferred** (Python/Go/Java through v0.165; Rust list_acls_all **v0.162**)
...
Still deferred: multi-language clients (Python/Go/Java through v0.165; Rust list_acls_all **v0.162**), full chaos-mesh suites / long fuzz
