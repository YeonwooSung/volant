...
- [ ] Multi-language clients (Rust first; Go / Python FFI or REST gateway) — **deferred** (Python/Go/Java through v0.99; Rust **v0.96–v0.100**)
...
Still deferred: multi-language clients (Python/Go/Java through v0.99; Rust **v0.96–v0.100**), full chaos-mesh suites / long fuzz
