...
- [ ] Multi-language clients (Rust first; Go / Python FFI or REST gateway) — **deferred** (Python/Go/Java through v0.85; Rust **v0.83–v0.84**)
...
Still deferred: multi-language clients (Python/Go/Java through v0.85; Rust **v0.83–v0.84**), full chaos-mesh suites / long fuzz
