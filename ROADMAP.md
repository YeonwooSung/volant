...
- [ ] Multi-language clients (Rust first; Go / Python FFI or REST gateway) — **deferred** (Python/Go/Java through v0.110; Rust **v0.107/v0.109**)
...
Still deferred: multi-language clients (Python/Go/Java through v0.110; Rust **v0.107/v0.109**), full chaos-mesh suites / long fuzz
