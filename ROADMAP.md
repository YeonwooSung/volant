...
- [ ] Multi-language clients (Rust first; Go / Python FFI or REST gateway) — **deferred** (Python/Go/Java through v0.119; Rust **v0.120**)
...
Still deferred: multi-language clients (Python/Go/Java through v0.119; Rust **v0.120**), full chaos-mesh suites / long fuzz
