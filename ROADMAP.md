...
- [ ] Multi-language clients (Rust first; Go / Python FFI or REST gateway) — **deferred** (Python/Go/Java through v0.200; Rust metadata_topic **v0.182**)
...
Still deferred: multi-language clients (Python/Go/Java through v0.200; Rust metadata_topic **v0.182**), full chaos-mesh suites / long fuzz
