...
- [ ] Multi-language clients (Rust first; Go / Python FFI or REST gateway) — **deferred** (Python/Go/Java through v0.145; Rust Fetch config **v0.144**)
...
Still deferred: multi-language clients (Python/Go/Java through v0.145; Rust Fetch config **v0.144**), full chaos-mesh suites / long fuzz
