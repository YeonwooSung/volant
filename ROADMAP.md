...
- [ ] Multi-language clients (Rust first; Go / Python FFI or REST gateway) — **deferred** (Python/Go/Java through v0.90; Rust **v0.87–v0.88**)
...
Still deferred: multi-language clients (Python/Go/Java through v0.90; Rust **v0.87–v0.88**), full chaos-mesh suites / long fuzz
