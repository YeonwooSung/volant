...
- [ ] Multi-language clients (Rust first; Go / Python FFI or REST gateway) — **deferred** (Python/Go/Java through v0.150; Rust fetch max_bytes **v0.149**)
...
Still deferred: multi-language clients (Python/Go/Java through v0.150; Rust fetch max_bytes **v0.149**), full chaos-mesh suites / long fuzz
