...
- [ ] Multi-language clients (Rust first; Go / Python FFI or REST gateway) — **deferred** (Python/Go/Java through v0.170; Rust list_offsets_all **v0.166**)
...
Still deferred: multi-language clients (Python/Go/Java through v0.170; Rust list_offsets_all **v0.166**), full chaos-mesh suites / long fuzz
