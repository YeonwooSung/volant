...
- [ ] Multi-language clients (Rust first; Go / Python FFI or REST gateway) — **deferred** (Python/Go/Java through v0.115; Rust **v0.111/v0.113/v0.114**)
...
Still deferred: multi-language clients (Python/Go/Java through v0.115; Rust **v0.111/v0.113/v0.114**), full chaos-mesh suites / long fuzz
