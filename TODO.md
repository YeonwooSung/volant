...
**Baseline:** HEAD product = **Phases 0–154** + residuals **v0.3–v0.185**.  
...
| **Later** | **Multi-language clients** | **Python/Go/Java through v0.185** + Rust metadata_topic **v0.182**; not kafka-python / SyncGroup |
...
- [x] Multi-language clients — Python/Go/Java through v0.185 (incl. MetadataTopic, Addr, assignor getter, SetEnableIdempotence) + Rust metadata_topic **v0.182**; not kafka-python / SyncGroup
