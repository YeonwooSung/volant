...
**Baseline:** HEAD product = **Phases 0–154** + residuals **v0.3–v0.195**.  
...
| **Later** | **Multi-language clients** | **Python/Go/Java through v0.195** + Rust metadata_topic **v0.182**; not kafka-python / SyncGroup |
...
- [x] Multi-language clients — Python/Go/Java through v0.195 (incl. Go config getters, language timeout) + Rust metadata_topic **v0.182**; not kafka-python / SyncGroup
