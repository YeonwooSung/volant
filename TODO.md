...
**Baseline:** HEAD product = **Phases 0–154** + residuals **v0.3–v0.175**.  
...
| **Later** | **Multi-language clients** | **Python/Go/Java through v0.175** + Rust add_broker_no_rack / create_scram_user_default / commit_transaction_empty **v0.172 / v0.174 / v0.175**; not kafka-python / SyncGroup |
...
- [x] Multi-language clients — Python/Go/Java through v0.175 (incl. AddBrokerNoRack, CreateScramUserDefault) + Rust add_broker_no_rack / create_scram_user_default / commit_transaction_empty **v0.172 / v0.174 / v0.175**; not kafka-python / SyncGroup
