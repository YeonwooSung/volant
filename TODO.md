...
**Baseline:** HEAD product = **Phases 0–154** + residuals **v0.3–v0.180**.  
...
| **Later** | **Multi-language clients** | **Python/Go/Java through v0.180** + Rust alter_config / fetch_offset **v0.178 / v0.180**; not kafka-python / SyncGroup |
...
- [x] Multi-language clients — Python/Go/Java through v0.180 (incl. CommitTransactionEmpty, AlterConfig, FetchOffset) + Rust alter_config / fetch_offset **v0.178 / v0.180**; not kafka-python / SyncGroup
