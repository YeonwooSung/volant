...
**Baseline:** HEAD product = **Phases 0–154** + residuals **v0.3–v0.170**.  
...
| **Later** | **Multi-language clients** | **Python/Go/Java through v0.170** + Rust list_offsets_all / reassign_partitions_all / create_acl **v0.166 / v0.168 / v0.170**; not kafka-python / SyncGroup |
...
- [x] Multi-language clients — Python/Go/Java through v0.170 (incl. ReassignAllPartitions, CreateAcl / DeleteAcl) + Rust list_offsets_all / reassign_partitions_all / create_acl **v0.166 / v0.168 / v0.170**; not kafka-python / SyncGroup
