...
**Baseline:** HEAD product = **Phases 0–154** + residuals **v0.3–v0.165**.  
...
| **Later** | **Multi-language clients** | **Python/Go/Java through v0.165** + Rust list_acls_all / delete_offset helpers **v0.162 / v0.165**; not kafka-python / SyncGroup |
...
- [x] Multi-language clients — Python/Go/Java through v0.165 (incl. ListAclsAll, ListOffsetsAll, DeleteOffset) + Rust list_acls_all / delete_offset helpers **v0.162 / v0.165**; not kafka-python / SyncGroup
