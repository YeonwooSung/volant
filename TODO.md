...
**Baseline:** HEAD product = **Phases 0–154** + residuals **v0.3–v0.160**.  
...
| **Later** | **Multi-language clients** | **Python/Go/Java through v0.160** + Rust Metadata 14 / fetch_offsets_all / producer getters **v0.157–v0.160**; not kafka-python / SyncGroup |
...
- [x] Multi-language clients — Python/Go/Java through v0.160 (incl. Metadata 14, DeleteOffsetsAll, producer getters) + Rust Metadata 14 / fetch_offsets_all **v0.157–v0.159**; not kafka-python / SyncGroup
