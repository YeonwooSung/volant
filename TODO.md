...
**Baseline:** HEAD product = **Phases 0–154** + residuals **v0.3–v0.190**.  
...
| **Later** | **Multi-language clients** | **Python/Go/Java through v0.190** + Rust metadata_topic **v0.182**; not kafka-python / SyncGroup |
...
- [x] Multi-language clients — Python/Go/Java through v0.190 (incl. GroupConsumer heartbeat_count, sessionTimeoutMs, Leave) + Rust metadata_topic **v0.182**; not kafka-python / SyncGroup
