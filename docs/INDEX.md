...
| [PHASE7_SPEC.md](./PHASE7_SPEC.md) … [PHASE110_SPEC.md](./PHASE110_SPEC.md) | Per-phase ship records (deep dive) |
...
## Compaction note (2026-07-19, post–Phase 110 ship)

Living docs match **git HEAD product** (`SUPPORTED_APIS`, last feature commit Phase **110**):

- **Status ceiling:** Phases **0–110**; Kafka shim **23–109** (107 = test isolation; 108 = ISR death; 109 = accept drain; 110 = alive-set auto-death)
- **Kafka SoT:** [KAFKA_COMPAT.md](./KAFKA_COMPAT.md) — matrix + semantic honesty
- **WHITEPAPER:** architecture + positioning; no full API matrix
- **Binding core:** PHASE1–6; **ship records:** PHASE7–110 via [PHASE_HISTORY](./history/PHASE_HISTORY.md)
...
- **Still deferred (product):** multi-lang, chaos/fuzz corpus CI, multi-broker 2PC /
  ...
  full Kafka broker catalog; straddle marker clip
