...
| Document | Purpose |
|----------|---------|
| [history/PHASE_HISTORY.md](./history/PHASE_HISTORY.md) | One-line index for phases 0–112 |
| [PHASE7_SPEC.md](./PHASE7_SPEC.md) … [PHASE112_SPEC.md](./PHASE112_SPEC.md) | Per-phase ship records (deep dive) |
...
## Compaction note (2026-07-19, post–Phase 112 ship)

Living docs match **git HEAD product** (`SUPPORTED_APIS`, last feature commit Phase **112**):

- **Status ceiling:** Phases **0–112**; Kafka shim **23–109** (107 = test isolation; 108 = ISR death; 109 = accept drain; 110 = alive-set auto-death; 111 = straddle marker clip; 112 = fuzz corpus smoke CI)
- **Kafka SoT:** [KAFKA_COMPAT.md](./KAFKA_COMPAT.md) — matrix + semantic honesty
- **WHITEPAPER:** architecture + positioning; no full API matrix
- **Binding core:** PHASE1–6; **ship records:** PHASE7–112 via [PHASE_HISTORY](./history/PHASE_HISTORY.md)
...
- **Still deferred (product):** multi-lang, chaos-mesh / long fuzz campaigns, multi-broker 2PC /
