...
| Document | Purpose |
|----------|---------|
| [history/PHASE_HISTORY.md](./history/PHASE_HISTORY.md) | One-line index for phases 0–134 (shipped) |
...
- **Status ceiling:** Phases **0–134** shipped. Kafka shim **23–109** (107 = test isolation; 108 = ISR death; 109 = accept drain; 110 = alive-set auto-death; 111 = straddle marker clip; 112 = fuzz corpus smoke CI; 113 = cluster admin fan-out; 114 = multi-broker 2PC MVP; 115 = durable fetch sessions; 116 = durable DeleteRecords outbox; 117 = ACL/BROKER admin catch-up; 118 = ISR rejoin + lag shrink; 119 = multi-broker fetch session handoff; 120 = transparent EndTxn forward; 121 = sticky FindCoordinator; 122 = AddOffsets / TxnOffsetCommit forward; 123 = DeleteRecords outbox leadership handoff; 124 = durable txn coordinator registry; 125 = time-based ISR lag shrink; 126 = PreferredReadReplica / rack-aware Fetch MVP; 127 = txn coordinator registry TTL GC; 128 = BROKER config for registry TTL; 129 = truncate journal; 130 = multi-controller majority journal; 131 = truncate journal rejoin catch-up; 132 = journal catch-up hardening; **133 = preferred selector polish**; **134 = p2p heartbeat mesh**)
- **Kafka SoT:** [KAFKA_COMPAT.md](./KAFKA_COMPAT.md) — matrix + semantic honesty
- **WHITEPAPER:** architecture + positioning; no full API matrix
- **Binding core:** PHASE1–6; **ship records:** PHASE7–134 via [PHASE_HISTORY](./history/PHASE_HISTORY.md)
