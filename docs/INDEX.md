...
## Compaction note (2026-07-24, post–Phase 113 ship)

Living docs match **git HEAD product** (`SUPPORTED_APIS`, last feature commit Phase **113**):

- **Status ceiling:** Phases **0–113**; Kafka shim **23–109** (107 = test isolation; 108 = ISR death; 109 = accept drain; 110 = alive-set auto-death; 111 = straddle marker clip; 112 = fuzz corpus smoke CI; **113 = cluster admin fan-out**)
- **Kafka SoT:** [KAFKA_COMPAT.md](./KAFKA_COMPAT.md) — matrix + semantic honesty
- **WHITEPAPER:** architecture + positioning; no full API matrix
- **Binding core:** PHASE1–6; **ship records:** PHASE7–113 via [PHASE_HISTORY](./history/PHASE_HISTORY.md)
...
- **Still deferred (product):** multi-lang, chaos-mesh / long fuzz campaigns, multi-broker 2PC /
  multi-broker session affinity / full KIP-890; full Kafka broker catalog
