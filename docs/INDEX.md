...
| Document | Purpose |
|----------|---------|
| [history/PHASE_HISTORY.md](./history/PHASE_HISTORY.md) | One-line index for phases 0–116 |
| [PHASE7_SPEC.md](./PHASE7_SPEC.md) … [PHASE116_SPEC.md](./PHASE116_SPEC.md) | Per-phase ship records (deep dive) |
...
## Compaction note (2026-07-25, post–Phase 116 ship)

Living docs match **git HEAD product** (`SUPPORTED_APIS`, last feature commit Phase **116**):

- **Status ceiling:** Phases **0–116**; Kafka shim **23–109** (107 = test isolation; 108 = ISR death; 109 = accept drain; 110 = alive-set auto-death; 111 = straddle marker clip; 112 = fuzz corpus smoke CI; 113 = cluster admin fan-out; 114 = multi-broker 2PC MVP; 115 = durable fetch sessions; **116 = durable DeleteRecords outbox**)
- **Kafka SoT:** [KAFKA_COMPAT.md](./KAFKA_COMPAT.md) — matrix + semantic honesty
- **WHITEPAPER:** architecture + positioning; no full API matrix
- **Binding core:** PHASE1–6; **ship records:** PHASE7–116 via [PHASE_HISTORY](./history/PHASE_HISTORY.md)
...
- **Cluster admin fan-out (Phase 113 + 116):** DeleteRecords best-effort replica truncate + **durable leader outbox** retry for offline peers (Phase 116); controller-only BROKER Alter + ACL Create/Delete with generationed push to live peers
