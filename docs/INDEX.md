...
| [PHASE7_SPEC.md](./PHASE7_SPEC.md) … [PHASE122_SPEC.md](./PHASE122_SPEC.md) | Per-phase ship records (deep dive) |
...
## Compaction note (2026-07-25, post–Phase 123 ship)

Living docs match **git HEAD product** (`SUPPORTED_APIS`, last feature commit Phase **123**):

- **Status ceiling:** Phases **0–123**; Kafka shim **23–109** (107 = test isolation; 108 = ISR death; 109 = accept drain; 110 = alive-set auto-death; 111 = straddle marker clip; 112 = fuzz corpus smoke CI; 113 = cluster admin fan-out; 114 = multi-broker 2PC MVP; 115 = durable fetch sessions; 116 = durable DeleteRecords outbox; 117 = ACL/BROKER admin catch-up; 118 = ISR rejoin + lag shrink; 119 = multi-broker fetch session handoff; 120 = transparent EndTxn forward; 121 = sticky FindCoordinator; 122 = AddOffsets / TxnOffsetCommit forward; **123 = DeleteRecords outbox leadership handoff**)
- **Kafka SoT:** [KAFKA_COMPAT.md](./KAFKA_COMPAT.md) — matrix + semantic honesty
- **WHITEPAPER:** architecture + positioning; no full API matrix
- **Binding core:** PHASE1–6; **ship records:** PHASE7–123 via [PHASE_HISTORY](./history/PHASE_HISTORY.md)
...
- **Multi-broker 2PC (Phase 114 + 120 + 121 + 122):** Enable2Pc EndTxn prepare/complete fans out to live peers; local `__txn_prepared` + controller `__txn_prepared/cluster.json`; fence complete-abort with `commit=false`; **EndTxn / AddOffsets / TxnOffsetCommit** to non-coordinator transparent-forwards to Init owner (Phase 120/122); **FindCoordinator** sticky murmur2 + Init-owner override (Phase 121); not full KIP-890/939
