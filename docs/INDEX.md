...
| Document | Purpose |
|----------|---------|
| [history/PHASE_HISTORY.md](./history/PHASE_HISTORY.md) | One-line index for phases 0–154 + residuals v0.3–v0.10 |
| [PHASE7_SPEC.md](./PHASE7_SPEC.md) … [PHASE154_SPEC.md](./PHASE154_SPEC.md) | Per-phase ship records (deep dive) |
| [V06_SPEC.md](./V06_SPEC.md) … [V10_SPEC.md](./V10_SPEC.md) | Residual slices (Kafka DR wait, preferred probe, app fence, changelog EOS, membership) |
