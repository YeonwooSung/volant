...
- Kafka `SUPPORTED_APIS` is **89** (… + StreamsGroupHeartbeat/Describe **88**/**89**, Alter/DeleteShareGroupOffsets **91**/**92**, BeginQuorumEpoch **53**). No stored quotas / KIP-584 features / token store / KIP-848 / KIP-932 / KIP-1071 / unclean election / live reassignment. No client-compat claim.
