...
- Kafka `SUPPORTED_APIS` is **69** (… + Envelope **58**, FetchSnapshot **59**, BrokerHeartbeat **63**, ConsumerGroupHeartbeat **68**, ControllerRegistration **70**). No stored quotas / KIP-584 features / token store / KIP-848 / unclean election / live reassignment. No client-compat claim.
