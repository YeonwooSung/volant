...
- Kafka `SUPPORTED_APIS` is **84** (… + Read/Write/DeleteShareGroupState **84**/**85**/**86**, ReadShareGroupStateSummary **87**, DescribeShareGroupOffsets **90**). No stored quotas / KIP-584 features / token store / KIP-848 / KIP-932 / unclean election / live reassignment. No client-compat claim.
