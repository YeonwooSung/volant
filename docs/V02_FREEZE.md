...
The Kafka shim is HEAD `SUPPORTED_APIS` (**49 keys**, v0.244). SyncGroup
...
| Kafka shim | Optional `--kafka-listen`; 49 keys at HEAD |
...
| Kafka `SUPPORTED_APIS` | 49 keys (`kafka/mod.rs`), including SyncGroup **14**, DescribeLogDirs **35**, ElectLeaders **43**, quotas **48**/**49** (empty/reject), Alter/ListPartitionReassignments **45**/**46**, Describe/AlterUserScramCredentials **50**/**51**, UpdateFeatures **57** (reject), UnregisterBroker **64**, DescribeTopicPartitions **75**. Native 116/117 is not a Kafka key. |
...
| Band | Content |
|------|---------|
| IN | HEAD `SUPPORTED_APIS` (49 keys): Produce 0–13, Fetch 0–18, Metadata 0–13, groups **including SyncGroup 14 v0–5**, SASL, txn MVP, ACL admin, configs, DescribeCluster / DescribeProducers / Describe+ListTransactions, **DescribeLogDirs 35**, **ElectLeaders 43**, **quotas 48/49** (empty/reject), **Alter/ListPartitionReassignments 45/46**, **SCRAM 50/51**, **UpdateFeatures 57** (reject), **UnregisterBroker 64**, **DescribeTopicPartitions 75**. |
...
154 or invent Kafka keys beyond the approved 49.
...
- **Kafka surface is 49 keys** (… + v0.241 **48**/**49**; v0.244 **57**; v0.242 **64**). SyncGroup **14** was already listed. Native 116/117 is not a Kafka key.
