...
| Txn wire | Init / Add* / End / TxnOffsetCommit | Write-through + soft markers; prepared 2PC MVP (Phase 90) + prepared/open timeout (Phase 92/93) + TRANSACTION_ABORTABLE subset (Phase 94) |
