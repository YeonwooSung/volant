...
| Shared session mirror + promote | 138 | Best-effort peer MirrorPut/Delete (opcodes 90–93); foreign mirror table; promote on owner forward miss; put lag/fail still **70**; not Raft; no session_id re-encode |
