...
| Kafka wire shim | 23–95 | Optional `--kafka-listen`; classic + flexible; **~38** keys; prepared 2PC (**90**) + timeouts (**92**/open **93**); omit-unchanged sessions (**91**); session TTL/max (**95**) |
