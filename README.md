...
> Status: **Phases 0–128 landed** — durable log, clustering (ISR death + rejoin /
> lag shrink + time-based ISR lag + PreferredReadReplica rack-aware Fetch +
> txn coordinator registry TTL GC + BROKER TTL config), security, stream operators, a broad optional Kafka wire shim
...
│   ├── PHASE7–128_SPEC.md # Ship records (see history/)
