...
> Status: **Phases 0–142 landed** — durable log, clustering (ISR death + rejoin /
...
time-based ISR lag shrink via `replica_lag_max_ms` (Phase 125); PreferredReadReplica max LEO lag + RC suppress metric (Phase 140); journal majority health gauges (Phase 141); Metadata leader ISR overlay + leader→controller IsrUpdate (Phase 142).
