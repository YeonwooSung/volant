...
// ProduceHeaders is Produce (acks=1) with native record headers on the
// single message. Produce / ProduceAcks still send empty headers.
// Reuses ProduceBatch retry / error 13 / error 21. Not Kafka RecordBatch.
