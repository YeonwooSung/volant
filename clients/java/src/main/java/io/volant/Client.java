...
public final class Client implements AutoCloseable {
    ...
    /**
     * Produce one message with native record headers and acks=1.
     * Four-arg {@link #produce(String, int, byte[], byte[])} still sends
     * empty headers. Reuses the batch retry / error 13 / error 21 path.
